      ...
      <main className="services-main">
        <section className="hero-section">
          <div className="container">
            <h1 className="page-title">Soluciones con Inteligencia Artificial</h1>
            <p className="page-subtitle">Automatizá, optimizá y llevá tu negocio al siguiente nivel con IA y automatización</p>
          </div>
        </section>
        ...
        <section className="service-category">
          <div className="container">
            <div className="category-header">
              <h2 className="category-title">Desarrollos a Medida</h2>
              <p className="category-description">Creamos experiencias web atractivas, funcionales y personalizadas</p>
            </div>
